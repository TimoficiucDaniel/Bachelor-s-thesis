...
namespace csDelaunay {
	...
	public class Voronoi {
		...
		public Voronoi(List<Vector2> points, Rectf plotBounds, int lloydIterations, int seed) {
			weigthDistributor = new Random(seed);
			Init(points,plotBounds);
		...
		private void LloydRelaxation(int nbIterations) {
